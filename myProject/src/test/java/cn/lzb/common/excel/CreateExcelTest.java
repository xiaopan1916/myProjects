...
public class CreateExcelTest {
     ...
     * 单例模式
     */
    private static CreateExcelTest instance = new CreateExcelTest();
    ...
    public static CreateExcelTest getInstance() {
        return instance;
    }
    ...
    public static void main(String[] args) {
        CreateExcelTest.getInstance().doCreate();
    }
}
