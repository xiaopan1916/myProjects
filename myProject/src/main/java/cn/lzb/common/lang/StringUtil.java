...
public class StringUtil {
     ...
     * 支持检查多个参数
     * <pre>
     *    StringUtil.isBlank("bob","") = ture
     *    StringUtil.isBlank("bob","bob") = false
     * </pre>
     *
     * @param srts 要检查的字符串
     *
     * @return  如果参数有一个为空白, 则返回<code>true</code>
     *
     */
     ...
     * 
     * @param array 指定数组
     * @return 字符串，数组为<code>NULL</code>，则返回<code>NULL</code>，数组为空，则返回空
     * @see com.hqb360.common.lang.StringUtil.toString(String[], String)
     */
     ...
     * toString(new String[]{ }, null) = ""
     * toString(new String[]{"a" , "b"}, null) = a,b
     * toString(new String[]{"a" , "b"}, "-") = a-b
     * </pre>
     *
     * @param array 指定数组
     * @param connector 指定连接符，若为<code>NULL</code>，则默认为","
     * @return 字符串，数组为<code>NULL</code>，则返回<code>NULL</code>，数组为空，则返回空
     */
    public static String toString(String[] array, String connector) {
        ...
        for (String arr : array) {
            sArray.append(arr);
            sArray.append(connector);
        }
        if (sArray.length() > 0) {
            sArray.delete(sArray.length() - connector.length(), sArray.length());
        }
     ...
     *
     * @param ite 指定迭代器
     * @return 字符串，迭代器为<code>NULL</code>，则返回<code>NULL</code>，迭代器为空，则返回空
     * @see com.hqb360.common.lang.StringUtil.toString(Iterable, String)
     */
    public static String toString(Iterable<String> ite) {
        return toString(ite, ",");
    }
     ...
     * 示例：
     * toString(null, null) = null
     * toString(new ArrayList&lt;String&gt;(), null) = ""
     *
     * List&lt;String&gt; list = new ArrayList&lt;String&gt;();
     * list.add("a");
     * list.add("b");
     * toString(list, null) = a,b
     * toString(list, "-") = a-b
     * </pre>
     *
     * @param ite 指定迭代器
     ...
     * @return 字符串，迭代器为<code>NULL</code>，则返回<code>NULL</code>，迭代器为空，则返回空
     */
    public static String toString(Iterable<String> ite, String connector) {
        if (null == ite) {
            return null;
        }
        if (null == connector) {
        ...
        for (String ele : ite) {
            sIte.append(ele);
            sIte.append(connector);
        }
        if (sIte.length() > 0) {
            sIte.delete(sIte.length() - connector.length(), sIte.length());
        }
     ...
     *
     * @param map 指定Map
     * @return 字符串，指定Map为<code>NULL</code>，则返回<code>NULL</code>，指定Map为空，则返回空
     * @see com.hqb360.common.lang.StringUtil.toString(java.util.Map, String)
     */
     ...
     * 示例：
     * toString(null, null) = null
     * toString(new HahMap&lt;String, String&gt;(), null) = ""
     * 
     * Map&lt;String, String&gt; map = new HashMap&lt;String, String&gt;();
     * map.put("akey","avalue");
     * map.put("bkey", "bvalue");
     * toString(map, null) = akey=avalue,bkey=bvalue
     * toString(map, "-") = akey=avalue-bkey=bvalue
     * </pre>
     * 
     * @param ite 指定指定Map
     * @param connector  指定连接符，若为<code>NULL</code>，则默认为","
     * @return 字符串，指定Map为<code>NULL</code>，则返回<code>NULL</code>，指定Map为空，则返回空
     */
    public static String toString(Map<String, String> map, String connector) {
        if (null == map) {
            return null;
        }
        if (null == connector) {
